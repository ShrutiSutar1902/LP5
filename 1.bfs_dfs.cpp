...
// if ($?) { g++ bfs_dfs.cpp -o bfs_dfs } ; if ($?) { .\bfs_dfs }
//cd "c:\Users\shruti\Downloads\" ; if ($?) { g++ bfs_dfs.cpp -o bfs_dfs } ; if ($?) { .\bfs_dfs }
...
// Windows (VS Code / PowerShell) Using OpenMP
// Compile
